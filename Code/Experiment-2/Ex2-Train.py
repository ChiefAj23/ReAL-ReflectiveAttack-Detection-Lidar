...
df_list = [
    pd.read_csv('nvidia_1_n.csv'),
    pd.read_csv('nvidia_1_s.csv'),
    pd.read_csv('nvidia_2_n.csv'),
    pd.read_csv('nvidia_2_s.csv'),
    pd.read_csv('nvidia_3_n.csv'),
    pd.read_csv('nvidia_3_s.csv'),
    pd.read_csv('nvidia_4_n.csv'),
    pd.read_csv('nvidia_4_s.csv'),
    pd.read_csv('nvidia_5_n.csv'),
    pd.read_csv('nvidia_5_s.csv')
]
...
df2 = pd.concat([
    pd.read_csv('nvidia_6_n_inference.csv'),
    pd.read_csv('nvidia_6_s_inference.csv')
], ignore_index=True)
