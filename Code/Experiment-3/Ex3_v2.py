...
df_list.append(pd.read_csv('recycle_ex2_n.csv'))
df_list.append(pd.read_csv('recycle_ex2_s.csv'))
df_list.append(pd.read_csv('nvidia_ex2_n.csv'))
df_list.append(pd.read_csv('nvidia_ex2_s.csv'))
df_list.append(pd.read_csv('battery_ex2_n.csv'))
df_list.append(pd.read_csv('battery_ex2_s.csv'))
...
df2_list = []
df2_list.append(pd.read_csv('tissue_ex1_n.csv'))
df2_list.append(pd.read_csv('tissue_ex1_s.csv'))
df2_list.append(pd.read_csv('tissue_ex2_n.csv'))
df2_list.append(pd.read_csv('tissue_ex2_s.csv'))
...
results_file = 'svm_ex3_gamma_results.csv'
